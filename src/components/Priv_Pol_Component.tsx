const Priv_Pol_Component = () => {
  return (
    <div id="Priv_Pol_Component">
      <style>
        {`
            #Priv_Pol_Component p{
                margin-top:10px;
                margin-bottom:10px;
            }
            #Priv_Pol_Component p.head{
                margin-top:20px;
                font-size:16px;
      ...
      <section>
        <b>Iamvkr</b> built the <b>Yo Music</b> app as a Free app. This SERVICE is provided by{' '}
        <b>Iamvkr</b> at no cost and is intended for use as is.
        <p>
        ...
        <p>
          ...
          meanings as in our Terms and Conditions, which are accessible at <b>Yo Music</b> unless
      ...
      <section>
        ...
        <p>
          ...
          retained on your device and is not collected by me in any way. The app does use
      ...
      <section>
        ...
        <p>
          ...
          Privacy Policy on this page. This policy is effective as of 1st June 2026.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          contact me at beecoder260@proton.me.
        </p>
      </section>
    </div>
  );
...
export default Priv_Pol_Component;
